...
const raw = { id: 'raw-lot-1', code: 'RM-APPLE-2609A', status: 'ACTIVE', item_code: 'SKU-APPLE-BASE', item_name: 'Apple base' }; const finished = { id: 'finished-lot-1', code: 'FG-UI-001', status: 'ACTIVE', item_code: 'SKU-APPLE-100', item_name: 'Apple Snack Pack 100g', depth: 1 };
